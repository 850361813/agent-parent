...
public interface MarketplaceWebServiceOrdersAsync extends MarketplaceWebServiceOrders {
     ...
     */
    Future<GetOrderResponse> getOrderAsync(GetOrderRequest request);
     ...
     */
    Future<GetServiceStatusResponse> getServiceStatusAsync(GetServiceStatusRequest request);
     ...
     */
    Future<ListOrderItemsResponse> listOrderItemsAsync(ListOrderItemsRequest request);
     ...
     */
    Future<ListOrderItemsByNextTokenResponse> listOrderItemsByNextTokenAsync(ListOrderItemsByNextTokenRequest request);
     ...
     */
    Future<ListOrdersResponse> listOrdersAsync(ListOrdersRequest request);
     ...
     */
    Future<ListOrdersByNextTokenResponse> listOrdersByNextTokenAsync(ListOrdersByNextTokenRequest request);
