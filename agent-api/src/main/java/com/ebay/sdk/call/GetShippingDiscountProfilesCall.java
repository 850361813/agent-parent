 ...
 * <br> <B>Output property:</B> <code>ReturnedCurrencyID</code> - The three-digit code of the currency to be used for shipping cost discounts and insurance for Combined Invoice orders. A discount profile can only be associated with a listing if the <b>CurrencyID</b> value of the profile matches the <b>Item.Currency</b> value specified in a listing.
 ...
 * <br> <B>Output property:</B> <code>ReturnedCalculatedHandlingDiscount</code> - This container consists of details related to how the seller may have specified/modified packaging and handling discounts that are applied
