 ...
 * item(s) remain unchanged in My eBay.
 * <br> <B>Input property:</B> <code>ListingType</code> - <span class="tablenote"><b>Note: </b> DO NOT USE THIS FIELD. Previously, this field's only purpose was to classify the order to be updated as a Half.com order. However, since API support for Half.com listings is being deprecated, this field is no longer applicable.
 * </span>
 ...
 * For a multiple line item (Combined Payment) order, <b>OrderID</b> must be
