 ...
 * <br>
 * <br>
 * <span class="tablenote"><b>Note:</b> A new "on-time shipping metric" became a new component of Seller Standards beginning in February 2016. On-time shipping means that the seller shipped the item before the "handling time" expired and/or the item was received by the buyer within the estimated delivery date window, which is established once the buyer purchases or commits to buy the item. Previously, a seller's account could be dinged just for getting a low rating for the "shippping time" Detailed Seller Rating. </span>
 ...
 * <br>
 * <span class="tablenote"><b>Note:</b> A new "on-time shipping metric" became a new component of Seller Standards beginning in February 2016. On-time shipping means that the seller shipped the item before the "handling time" expired and/or the item was received by the buyer within the estimated delivery date window, which is established once the buyer purchases or commits to buy the item. Previously, a seller's account could be dinged just for getting a low rating for the "shippping time" Detailed Seller Rating. </span>
 * <br> <B>Output property:</B> <code>ReturnedFeedbackID</code> - The unique identifier of the Feedback entry that has been left.
 * 
 * @author Ron Murphy
 * @version 1.0
 */
