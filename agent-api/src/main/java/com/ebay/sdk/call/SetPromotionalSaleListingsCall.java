 ...
 * <br> <B>Input property:</B> <code>StoreCategoryID</code> - If a <b>StoreCategoryID</b> value is included in the call request, all active items in this store category are added to the promotional sale. This field cannot be used if the <b>Action</b> field is set to 'Delete'.
