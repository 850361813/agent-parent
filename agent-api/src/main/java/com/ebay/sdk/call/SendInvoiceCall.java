 ...
 * <br> <B>Input property:</B> <code>InsuranceOption</code> - Specifies whether an insurance fee is required. An <b>InsuranceOption</b> value of <b>IncludedInShippingHandling</b> cannot be used if the item will use calculated shipping. Some shipping carriers automatically include shipping insurance for qualifying items.<br>
 * <br> <B>Input property:</B> <code>InsuranceFee</code> - Insurance cost, as set by seller, if ShippingType = 1.
 * Specify if <b>InsuranceOption</b> is optional or required. Must be greater than zero value if a value of Optional or Required is passed in <b>InsuranceOption</b>. Value specified should be the total cost of insuring the item.<br>
 ...
 * <br> <B>Input property:</B> <code>PayPalEmailAddress</code> - If the <b>PaymentMethods</b> field is used and set to PayPal, the seller provides his/her PayPal email address in this field.
