 ...
 * <br> <B>Input property:</B> <code>IncludeHighPriorityMessageOnly</code> - If this field is included in the request and set to True, only High Priority messages are returned in the response.
