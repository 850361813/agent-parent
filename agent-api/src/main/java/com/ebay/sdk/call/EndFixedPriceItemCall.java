 ...
 * <br> <B>Output property:</B> <code>ReturnedEndTime</code> - Timestamp that indicates the date and time (GMT) that the specified item listing was ended.
 * <br> <B>Output property:</B> <code>ReturnedSKU</code> - If a SKU (stock-keeping unit) exists for the item listing, it is returned in the response.
 * 
 * @author Ron Murphy
 * @version 1.0
 */
